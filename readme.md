...
<h4>Este é um simples script em programado em Javascript executado por <br>``` NodeJS ``` <br>
 que utiliza a biblioteca <a href=https://www.npmjs.com/package/chalk-rainbow>chalk-rainbow</a></h1>
